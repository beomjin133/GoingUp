...
// Area chart
function AreaChart({ data, height = 120, color = "#1A55F0", fillOpacity = 0.12, showAxis = false }) {
...
// Sparkline
function Sparkline({ data, width = 80, height = 24, color = "#1A55F0" }) {
...
// Donut chart (absolute allocation)
...
Object.assign(window, { Logo, Icon, AssetLogo, KindTag, AreaChart, Sparkline, Donut });
